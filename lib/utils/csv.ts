/**
 * Small dependency-free CSV helpers. Good enough for the product
 * import/export use case (quoted fields, embedded commas/newlines/quotes)
 * without pulling in a parsing library for one feature.
 */
