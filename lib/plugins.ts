...
export const PLUGIN_CATALOG: PluginSeed[] = [
  ...
  },
  {
    ...
    price: 20000,
    billingInterval: "MONTHLY",
    eligibleBusinessTypes: ["Restaurant", "Food & Groceries"],
    sortOrder: 65,
    plans: ["Business Mogul"],
  },
  {
    ...
    description: "A lean, staff-facing service workspace: POS, live orders, tables & reservations, a read-only menu view, customers and daily reports. Menu editing and pricing stay restricted to owners and managers.",
    category: "Industry",
    icon: "ChefHat",
    price: 20000,
    billingInterval: "MONTHLY",
