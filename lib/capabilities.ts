...
function navigationFor(type: string, capabilities: Capability[]): Array<{ label: string; href: string }> {
  ...
  if (type === "Hotel & Lodging") return [{label:"Home",href:"/"},{label:"Rooms",href:"/rooms"},{label:"Dining",href:"/dining"},{label:"Amenities",href:"/amenities"},{label:"Events",href:"/events"},{label:"Gallery",href:"/gallery"},{label:"Offers",href:"/offers"},{label:"Contact",href:"/contact"}];
...
export const BUSINESS_TYPES: Record<string, BusinessTypeConfig> = {
  ...
  "Professional Services": {
    icon: Briefcase,
    tagline: "Professional services — choose a specialty to tailor your workspace",
    capabilities: ["services", "bookings", "portfolio", "packages", "reviews"],
    defaultCategories: defaultCategoriesFor("Professional Services", ["services", "bookings", "portfolio", "packages", "reviews"]),
    navigation: navigationFor("Professional Services", ["services", "bookings", "portfolio", "packages", "reviews"]),
    homepageSections: homepageFor("Professional Services", ["services", "bookings", "portfolio", "packages", "reviews"]),
    quickActions: [
      { label: "Add a service", href: "/services/new" },
