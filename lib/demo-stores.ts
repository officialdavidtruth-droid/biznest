...
export const DEMO_STORES: DemoStoreSeed[] = [
  ...
  },
  {
    ...
    products: [
      { name: "Air Runner '99 — White/Grey", description: "Retro runner silhouette, premium leather upper.", price: 68000, compareAtPrice: 82000, category: "Fashion", imageQuery: "white sneakers studio shot" },
      { name: "Court Classic — Triple Black", description: "All-black low top, everyday essential.", price: 54000, category: "Fashion", imageQuery: "black sneakers studio shot" },
      { name: "Trail Max — Volt", description: "High-visibility trail sneaker, aggressive tread.", price: 72000, category: "Fashion", imageQuery: "trail sneakers colorful" },
      ...
      { name: "Canvas Low — Cream", description: "Minimalist canvas low top.", price: 41000, compareAtPrice: 48000, category: "Fashion", imageQuery: "canvas sneakers cream" },
      { name: "Heenzy Cap — Snapback", description: "Structured snapback, embroidered front.", price: 12500, category: "Fashion", imageQuery: "snapback cap streetwear" },
      { name: "Limited Drop — Sunset Fade", description: "Limited release, gradient upper, numbered box.", price: 95000, category: "Fashion", imageQuery: "colorful gradient sneakers limited" },
      { name: "Crew Socks 3-Pack", description: "Cushioned crew socks, logo detail.", price: 6500, category: "Fashion", imageQuery: "crew socks pack" },
    ],
    reviews: [
