...
const PROFESSIONAL_SERVICE_THEMES = [
  { id:"graphic-design", name:"Print Studio — Graphic Design & Print", category:"Professional Services · Creative & Print", bg:"#FFFFFF", ink:"#101318", card:"#FFFFFF", accent:"#0D78F2", accentSoft:"#D516B5", muted:"#667085", border:"#E5E7EB", headline:"High-Quality Printing Solutions for Every Need", sub:"Premium creative, branding and print production.", professionalMode:"graphic-design" },
