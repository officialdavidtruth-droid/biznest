...
export default async function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <section
        className="relative grid gap-10 overflow-hidden px-6 pb-16 pt-8 sm:px-10 lg:grid-cols-2 lg:items-center lg:gap-6 lg:pt-16"
        style={{ background: "var(--bn-ink)" }}
      >
      ...
      <section
        ...
        style={{
          background: "var(--bn-ink)",
          borderTop: "1px solid var(--bn-ink-line)",
          borderBottom: "1px solid var(--bn-ink-line)",
        }}
      >
      ...
      {/* Final CTA */}
      <section className="relative overflow-hidden px-6 py-20 text-center sm:px-10 lg:py-28" style={{ background: "var(--bn-ink)" }}>
