...
export default async function StorefrontPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Retired/unknown templates must never expose an internal development
  // state to customers. Fall back to the universal builder experience using
  // the store's actual business data.
