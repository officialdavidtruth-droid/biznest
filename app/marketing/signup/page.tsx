  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-3xl px-5 py-14">
        <p className="text-xs font-bold uppercase tracking-[.22em] text-orange-400">Get started</p>
        <h1 className="mt-3 text-3xl font-extrabold sm:text-4xl">Just your business info.<br /><span className="text-orange-400">Nothing else.</span></h1>
        ...
        <div className="mt-8 rounded-3xl border border-blue-800 bg-slate-900/80 p-6 shadow-2xl sm:p-8">
          <MarketingSignupForm />
        </div>
      </section>
    </main>
