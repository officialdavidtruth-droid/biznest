            ...
            >
              <div
                ...
                style={{
                  background: t.previewUrl
                    ? `linear-gradient(0deg, ${theme.bg}f2, ${theme.bg}66), url(${t.previewUrl}) center/cover`
                    : theme.bg,
                  color: theme.ink,
              ...
              >
                <div className="flex h-full flex-col justify-end p-5">
                  <span
                    className="mb-2 w-fit rounded px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide"
                    style={{ color: theme.accent, border: `1px solid ${theme.accent}` }}
                  >
                    {theme.eyebrow}
                  </span>
                  <p className="text-base font-bold leading-tight">{theme.headline}</p>
                </div>
              </div>
