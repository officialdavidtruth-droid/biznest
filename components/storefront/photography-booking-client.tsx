      ...
      <main style={{ maxWidth: 1180, margin: "auto", padding: "25px 5vw 70px" }}>
        <div className="photo-book-grid">
          <section>
            ...
            <div className="bn-grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 10, fontSize: 10 }}>{['Professional Equipment','Expert Photography','Photo Editing','Online Gallery','Print Release'].map(x=><div key={x} style={{ padding: 8, background:'#faf9f7' }}>▣<br/><b>{x}</b></div>)}</div>
          </section>
        ...
        <section className="bn-2col" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:18,marginTop:22}}>
