    ...
    <aside className="bn-admin-sidebar hidden h-screen max-h-screen w-[250px] shrink-0 flex-col overflow-y-auto overscroll-contain border-r border-[color:var(--bn-ink-line)] bg-[color:var(--bn-ink)] text-white lg:sticky lg:top-0 lg:flex lg:self-start">
      <div className="border-b border-slate-800 px-4 py-4">
        <div className="mb-4 flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#ff7900] text-[#071a33] text-sm font-black text-white shadow-sm">▰</div>
          <div>
      ...
      <div className="border-t border-slate-800 px-3 py-3">
        <div className="mb-3 rounded-xl border border-slate-700 bg-slate-900/80 p-3">
          ...
          <Link href={`/${slug}/admin/subscription`} className="block rounded-md bg-[#ff7900] text-[#071a33] px-2 py-1.5 text-center text-[10px] font-bold text-white">Manage Plan</Link>
        </div>
      ...
      return (
        <a
          ...
          className={`group relative flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm transition-colors ${
            isActive ? "bg-[#ff7900] text-[#071a33] font-medium text-white shadow-sm" : "text-slate-300 hover:bg-white/8 hover:text-white"
          }`}
        >
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2 rounded-lg px-2.5 py-1.5 text-xs transition-colors ${
                  childIsActive ? "bg-[#ff7900] text-[#071a33]/90 font-medium text-white" : "text-slate-400 hover:bg-white/8 hover:text-white"
                }`}
              >
